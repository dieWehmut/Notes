<template>
    ...
    <div class="about-me">
      ...
      <div class="about-content">
          ...
          <div class="contact">
            ...
            <!-- Nexus button: 新增，位于 GitHub 按钮下方 -->
            <a class="nexus-btn" href="https://www.hc-dsw-nexus.me" target="_blank" rel="noopener noreferrer">
  ...
  <!-- Navigation buttons moved to the search area for unified placement across viewports -->
  </nav>
</template>
...
async function fetchLatestCommit() {
  try {
    ...
    const res = await fetch('https://api.github.com/repos/dieWehmut/Notes/commits?per_page=1');
    if (!res.ok) return;
...
/* Nexus button matches GitHub button styling but with a distinct hover tint */
.nexus-btn {
  display: inline-flex;
  align-items: center;
